...
class register_controller extends GetxController {
  ...
  void register(String username, String email, String password, String confirm_password) async {
    if (username.isEmpty ||
        email.isEmpty ||
        password.isEmpty ||
      ...
      if (password != confirm_password) {
        ...
        try {
          ...
          var request = http.Request('POST', Uri.parse('http://10.0.2.2:8000/api/register'));
