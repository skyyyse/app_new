<div class="modal fade" id="slider_update" tabindex="-1" aria-labelledby="fullscreeexampleModalLabel" aria-hidden="true">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select id="active" name="active" class="form-control form-control-sm @error('active')border-danger  @enderror">
