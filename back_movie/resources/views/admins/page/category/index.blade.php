...
<body>
                        ...
                        <div class="col-12">
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <a class="btn btn-success" href="{{route('admin.category.create')}}">New users</a>
                                </div>
                                ...
                                <div class="card-body">
                                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $key+1}}</td>
                                                <td style="display: flex;align-items: center;justify-content: center;margin: 0;height: 1005;"><img src="{{ asset('file/category/image/'.$categories_data->category_image) }}" alt="" style="height: 30px;border-radius: 2px;"></td>
                                                <td>{{ $categories_data->category_title }}</td>
                                                <td style="color: <?php echo $categories_data->category_active == 0 ? 'red' : 'blue'; ?>">{{ $categories_data->category_active ==0?"Disable":"Enable"}}</td>
                                                <td>{{ $categories_data->created_at }}</td>
                                                <td style="margin: 30px;padding: 10px;">
                                                    <button type="button" value="{{$categories_data->id}}" class="btn btn-outline-danger category_delete" data-bs-toggle="modal" data-bs-target="#category_delete">
                                                        <i class="ri-delete-bin-2-line"></i>
                                                    </button>
                                                    <button type="button" value="{{$categories_data->id}}" class="btn btn-outline-secondary category_update" data-bs-toggle="modal" data-bs-target="#category_update">
    ...
    @include('admins.page.category.delete')
    @include('admins.page.category.update')
