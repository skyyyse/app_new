            ...
            <div class="card-body d-flex flex-column h-100 gap-3">
                ...
                <div class="my-auto">
                    ...
                    <form action="{{route('admin.auth.login')}}" method="post">
                        ...
                        <p class="error" style="color:red;">{{Session::get('error')}}</p>
                        @endif
                        <div class="mb-3">
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Don't have an account? <a href="{{route('admin.auth.page.register')}}" class="text-muted ms-1"><b>Sign Up</b></a></p>
                </footer>
            </div>
        </div>
